...
# AMQP参数名称
AMQP_NoWait = "NoWait"
AMQP_Durable = "NoWDurableait"
AMQP_AutoDelete = "AutoDelete"
AMQP_Internal = "Internal"
AMQP_Args = "Args"
AMQP_Exclusive = "Exclusive"
AMQP_AutoAck = "AutoAck"

# NSQ参数名称
NSQ_AuthSecret = "auth_secret"
NSQ_TOPIC = "topic"
# RabbitMQ
Expires = "x-expires"
# Ali AMQP
...
AMQPPubiishOPT = {
    "Exchange": "",
    "Key": "",
    "Mandatory": 0,  # //至少将消息route到一个队列中，否则就将消息return给发送者
    "Immediate": 0  # //至少将消息route到一个队列中，否则就将消息return给发送者 rabbitmq 3.0不支持
}
